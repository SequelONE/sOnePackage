...
class ServiceTest extends PHPUnit_Framework_TestCase {
    /** @var  \sequelone\sOnePackage\sOnePackage */
    public $service;

    public function setUp() {
        global $modx;
        $this->service = new \sequelone\sOnePackage\sOnePackage($modx);
    }

    public function testIsProperObject() {
        $this->assertTrue($this->service instanceof \sequelone\sOnePackage\sOnePackage);
    }
