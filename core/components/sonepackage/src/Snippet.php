...
namespace sequelone\sOnePackage;

use sequelone\sOnePackage\Exceptions\InvalidPropertyException;
use sequelone\sOnePackage\Properties\SnippetProperty;
 ...
 * 
 * @package sequelone\sOnePackage
 */
abstract class Snippet
{
    /** @var sOnePackage $service */
    public $service;
     ...
     * 
     * @param sOnePackage $service
     * @param bool $strict
     */
    final public function __construct(sOnePackage $service, $strict = false)
    {
     ...
     *
     * @return string
     * @throws \sequelone\sOnePackage\Exceptions\InvalidPropertyException
     */
    final public function getPropertyHash()
    {
        ...
        foreach ($this->properties as $key => $property) {
            if ($property instanceof SnippetProperty) {
                ...
                throw new \sequelone\sOnePackage\Exceptions\InvalidPropertyException($key . ' is not a proper property!');
            }
        }
